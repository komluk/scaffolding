...
tools: Read, Edit, Write, Bash, Grep, Glob, mcp__memory__memory-search_context, mcp__memory__memory-semantic_search, mcp__memory__memory-semantic_recall
model: sonnet
effort: high
skills:
  - mcp-tools
...
- `mcp__memory__semantic_store` -- persist MCP transport gotchas, schema patterns, and launcher lessons
